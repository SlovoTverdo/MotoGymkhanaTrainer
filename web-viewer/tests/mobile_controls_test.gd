...
func _run() -> void:
	...
	_expect(fixture._joystick.position.is_equal_approx(Vector2(20.0, 270.0)), "joystick layout is centered along the left viewport side")
	...
	fixture._center_joystick()
	_expect(fixture._joystick.position.is_equal_approx(Vector2(16.0, 280.0)), "portrait joystick remains vertically centered and left-aligned")
